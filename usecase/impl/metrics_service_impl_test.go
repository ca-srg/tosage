...
func TestNewMetricsServiceImpl(t *testing.T) {
	...
	service := NewMetricsServiceImpl(ccService, nil, nil, metricsRepo, config, &mockLogger{}, timezoneService)
	if service == nil {
...
func TestMetricsServiceImpl_StartPeriodicMetrics(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			metricsRepo := &mockMetricsRepository{}
			timezoneService := &MockTimezoneService{Location: time.UTC}
			service := NewMetricsServiceImpl(ccService, nil, nil, metricsRepo, tt.config, &mockLogger{}, timezoneService)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.cursorService != nil {
				service = NewMetricsServiceImpl(ccService, tt.cursorService, nil, metricsRepo, config, &mockLogger{}, timezoneService)
			} else {
				service = NewMetricsServiceImpl(ccService, nil, nil, metricsRepo, config, &mockLogger{}, timezoneService)
			}
...
func TestMetricsServiceImpl_CursorMetrics_Values(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			timezoneService := &MockTimezoneService{Location: time.UTC}
			service := NewMetricsServiceImpl(ccService, cursorService, nil, metricsRepo, config, &mockLogger{}, timezoneService)
...
func TestMetricsServiceImpl_GracefulDegradation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			timezoneService := &MockTimezoneService{Location: time.UTC}
			service := NewMetricsServiceImpl(tt.ccService, tt.cursorService, nil, metricsRepo, config, &mockLogger{}, timezoneService)
